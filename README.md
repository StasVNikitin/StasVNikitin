...
1С, СКД, БСП, Консоль запросов, 1С Предприятие 8.3, 8.2, SQL, XML, JSON, CVS, Linux, Windows, Bash, PostgreSQL, Apache, Nginx, Git, REST, Postfix, HTML, CSS, JS, PHP, Laravel Framework, Python, Django Framework,  KVM, Docker, Docker-compose, VMWare, HyperV
...
- Обеспечиваю техническое обслуживание, сопровождение, обновление всех 1с баз включая доработанные КОРП конфигурации, доработку конфигураций по ТЗ и техническую поддержку пользователей.
